...
- **Stable release:** 11.4.1 / 3 July 2026
...
*(135 numbered references to drupal.org, news outlets, academic sources, and other citations supporting the article's claims, including citations for release dates, security advisories, community statistics, and notable users.)*

Notable citation details:

- "How does Drupal compare to ▌▌▌▌? discussion thread". drupal.org. 17 January 2005.
- Spencer, Jamie (7 April 2017). "CMS Battle for Beginners: ▌▌▌▌ vs ▌▌▌▌ vs Drupal (Infographic)". MakeAWebsiteHub.com.
