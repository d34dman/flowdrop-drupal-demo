...
2. ^ a b "drupal 11.4.1". Retrieved 8 July 2026.
3. ^ a b "Licensing FAQ". *drupal.org*. Retrieved 8 April 2009.
...
14. ^ a b "Drupal for Developers | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 April 2017. `{{cite web}}`: CS1 maint: deprecated archival service (link)
15. ^ a b "Module Project". *Drupal.org*. 18 March 2022. Archived from the original on 23 June 2023. Retrieved 23 June 2023.
16. ^ a b "Theme project | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 September 2017. `{{cite web}}`: CS1 maint: deprecated archival service (link)
...
21. ^ a b "Features". *drupal.org*. Retrieved 8 April 2009.
...
29. ^ a b "Drupal 8 releases; drupal.org". Retrieved 18 December 2022.
...
36. ^ a b Miller, Ron (22 January 2021). "Drupal's journey from dorm-room project to billion-dollar exit". *TechCrunch*. Retrieved 20 September 2022.
...
40. ^ a b "History". *drupal.org*. Retrieved 8 April 2009.
...
62. ^ a b Shetty, Shefali. "How Drupal 8 aims to be future-proof | Opensource.com". *opensource.com*. Retrieved 18 September 2025.
...
69. ^ a b "Never hack core". *drupal.org*. 16 May 2007.
70. ^ a b "Documentation: Core modules and themes". *drupal.org*. 4 November 2016. Retrieved 22 January 2021.
...
82. ^ a b "Drupal 6.0 released". *drupal.org*. 13 February 2008. Retrieved 8 April 2009.
...
99. ^ a b Arghire, Ionut (29 September 2022). "Drupal Updates Patch Vulnerability in Twig Template Engine | SecurityWeek.Com". *www.securityweek.com*. Retrieved 11 October 2022.
...
110. ^ a b Kaur Dadiala, Karanjeet (8 August 2022). "16 Organization Websites Built Using Drupal in 2022". *Zyxware Technologies*. Retrieved 9 October 2022.
111. ^ a b c d e f Montti, Roger (22 April 2022). "Drupal Warns of Two Critical Vulnerabilities". *Search Engine Journal*. Retrieved 23 October 2022.
...
114. ^ a b Blyaert, Luc (18 October 2022). "Tobania trekt CM binnen met Dries Buytaert". *www.computable.be* (in Dutch). Retrieved 18 October 2022.
