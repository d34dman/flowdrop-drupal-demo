...
This article **relies excessively on references to primary sources**. Please improve this article by adding secondary or tertiary sources. *(October 2022)*

| | |
|---|---|
| **Original author** | Dries Buytaert |
| **Developer** | Drupal community |
| **Release** | January 15, 2001; 25 years ago |
| **Stable release** | 11.4.1 / 3 July 2026; 57 days ago |
...
| 11.4.1 (Latest version) | 3 July 2026[2] |
| 10.6.2 (Supported) | 8 January 2026[26] |
| 7.103 (Unsupported) | 4 December 2024[27] |
| 9.5.11 (Unsupported) | 20 September 2023[28] |
| 8.9.20 (Unsupported) | 17 December 2021[29] |
| 6.38 (Unsupported) | 24 February 2016[30] |
| 5.23 (Unsupported) | 11 August 2010[31] |
| 4.7.11 (Unsupported) | 10 January 2008[32] |
| 3.0 (Unsupported) | 15 September 2001[33] |
| 2.0 (Unsupported) | 15 March 2001[34] |
| 1.0 (Unsupported) | 15 January 2001[35] |
...
As of 2014, Drupal is developed by a community.[46] From July 2007 to June 2008, the Drupal.org site provided more than 1.4 million downloads of Drupal software, an increase of approximately 125% from the previous year.[47][48]
...
Drupal core is modular, defining a system of hooks and callbacks, which are accessed internally via an API.[89] This design allows third-party contributed modules and themes to extend or override Drupal's default behaviors without changing Drupal core's code.
