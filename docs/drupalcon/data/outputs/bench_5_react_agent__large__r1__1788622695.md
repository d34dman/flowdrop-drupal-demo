...
Drupal![Drupal logo](Logo_drupal.png)Original authorDries BuytaertDeveloperDrupal communityReleaseJanuary 15, 2001; 25 years agoStable release11.4.1 / 3 July 2026; 2 months agoWritten inPHP, using SymfonyOperating systemUnix-like, WindowsPlatformWeb platformSize100 MBTypeContent management framework
Content management system
Blog software
Open source
Knowledge managementLicenseGPL-2.0-or-laterWebsitedrupal.orgRepositoryDrupal Repository**Drupal** (/ˈdruːpəl/) is a free and open-source web content management system (CMS) written in PHP and distributed under the GNU General Public License. Drupal provides an open-source back-end framework for at least 14% of the top 10,000 websites worldwide and 1.2% of the top 10 million websites—ranging from personal blogs to corporate, political, and government sites. Drupal can also be used for knowledge management and for business collaboration.
...
Latest major and supported releasesVersionRelease dateLatest version: 11.4.13 July 2026Supported: 10.6.28 January 2026Unsupported: 7.1034 December 2024Unsupported: 9.5.1120 September 2023Unsupported: 8.9.2017 December 2021Unsupported: 6.3824 February 2016Unsupported: 5.2311 August 2010Unsupported: 4.7.1110 January 2008Unsupported: 3.015 September 2001Unsupported: 2.015 March 2001Unsupported: 1.015 January 2001Drupal was originally written by Dries Buytaert as a message board for his friends to communicate in their dorms while working on his Master's degree at the University of Antwerp. After graduation, Buytaert moved the site to the public internet and named it Drop.org. Between 2003 and 2008, Buytaert worked towards a PhD degree at Ghent University.
