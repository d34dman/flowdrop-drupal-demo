...
Release: January 15, 2001; 25 years ago (2001-01-15)

Stable release: 11.4.1 / 3 July 2026; 2 months ago
...
This article **relies excessively on references to primary sources**. Please improve this article by adding secondary or tertiary sources. *Find sources:* "Drupal" – news · newspapers · books · scholar · JSTOR *(October 2022)* *(Learn how and when to remove this message)*
...
As of March 2022[update], the Drupal community had more than 1.39 million members, including 124,000 users actively contributing, resulting in more than 50,000 free modules that extend and customize Drupal functionality, over 3,000 free themes that change the look and feel of Drupal, and at least 1,400 free distributions that allow users to quickly and easily set up a complex, use-specific Drupal in fewer steps.
...
|---|---|
| Latest version: 11.4.1 | 3 July 2026 |
...
Drupal 8 was first released on 19 November 2015. This was the first to use Symfony for components and Twig "Twig (template engine)") as a template engine and it also used the Composer "Composer (software)") for managing dependencies. The last Drupal 8 was version 8.9.20 which was released on 17 December 2021.
...
Core modules also include a hierarchical taxonomy "Taxonomy (general)") system, which lets developers categorize content or tag "Tag (metadata)") with keywords for easier access.
...
Drupal core is modular, defining a system of hooks and callbacks "Callback (computer programming)"), which are accessed internally via an API. This design allows third-party contributed [modules](#Modules) and [themes](#Themes) to extend or override Drupal's default behaviors without changing Drupal core's code.
...
12. ↑ "Getting Involved | Drupal.org". *www.drupal.org*. 21 December 2019. Retrieved 21 September 2018. Drupal.org Activity
...
- Use dmy dates from November 2025
