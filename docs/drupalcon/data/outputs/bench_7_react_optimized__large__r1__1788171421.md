...
Stable release: 11.4.1[2] / 3 July 2026; 59 days ago
...
Drupal core is modular, defining a system of hooks and callbacks "Callback (computer programming)"), which are accessed internally via an API.[89] This design allows third-party contributed modules and themes to extend or override Drupal's default behaviors without changing Drupal core's code.
...
14. "Drupal for Developers | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 April 2017. `{{cite web}}`: CS1 maint: deprecated archival service (link)
15. "Module Project". *Drupal.org*. 18 March 2022. Archived from the original on 23 June 2023. Retrieved 23 June 2023.
16. "Theme project | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 September 2017. `{{cite web}}`: CS1 maint: deprecated archival service (link)
...
26. ↑ . Retrieved 17 January 2026. `{{cite web}}`: Missing or empty `|title=` (help)
...
41. ↑ Melançon, Benjamin; et al. (2011). *The Definitive Guide to Drupal 7* (2nd ed.). Apress. p. 823. ISBN "ISBN (identifier)") 9781430231356.
...
59. ↑ "Xplain Hosting Drupal 7 Quickstart training seminar". Scoop "Scoop (website)"). 16 December 2010.
