...
**Drupal** (/ˈdruːpəl/) is a free and open-source web content management system (CMS) written in PHP and distributed under the GNU General Public License.[3][5][6] Drupal provides an open-source back-end framework for at least 14% of the top 10,000 websites worldwide[7] and 1.2% of the top 10 million websites[8]—ranging from personal blogs to corporate, political, and government sites.[9] Drupal can also be used for knowledge management and for business collaboration.[10]
...
3. [Extending the core](#Extending_the_core)
   - 3.1 [Modules](#Modules)
   - 3.2 [Themes](#Themes)
...
14. 1 2 "Drupal for Developers | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 April 2017.
15. 1 2 "Module Project". *Drupal.org*. 18 March 2022. Archived from the original on 23 June 2023. Retrieved 23 June 2023.
16. 1 2 "Theme project | Drupal.org". *www.drupal.org*. 18 March 2022. Retrieved 21 September 2017.
