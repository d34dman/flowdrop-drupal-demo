About | Drupal.org   [Skip to main content](#content) [Skip to search](#search-block-form) 
...
- Community
    ...
    - News &amp; Blogs
    - Forum
    - [Slack](/community/contributor-guide/reference-information/talk/tools/slack "Get support and comminicate with the global Drupal community.")
    - Newsletters
    - Drupal Swag Shop
- [Support Drupal](/association "Support the Drupal Association - the non-profit that supports the Drupal project")
    ...
    - [Become a Drupal Sustaining Member](<https: www.drupal.org sustaining-members>)
    - Drupal Swag Shop
...
- [](#block-system-user-menu)
    - [Log in](/user/login?destination=node/2603760)
    - [Create account](/user/register?destination=node/2603760)
...
There are lots of [companies who'd love to help with your Drupal project](/marketplace "Drupal services marketplace"). They're experts in design, development, [hosting](/hosting), spam blocking, theming, [training](/training-services), and more. If, instead, you're looking for a new employee or freelancer, try the best place for hiring great Drupal talent: Drupal Jobs.
  ...
  [Infrastructure management for Drupal.org provided by ![Tag1 logo](/sites/all/modules/drupalorg/drupalorg/images/tag1-w.svg)](https://www.tag1.com/?utm_source=DA&amp;utm_medium=referral&amp;utm_campaign=drupal-org-footer) 
...
Drupal is a [registered trademark](/about/trademark) of Dries Buytaert.</https:>