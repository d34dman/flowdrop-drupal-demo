Now I'll present the markdown content with Drupal's competitors replaced by "▌▌▌▌". The main competitors of Drupal CMS are **▌▌▌▌** (WordPress), **▌▌▌▌** (Joomla), and **▌▌▌▌** (others like TYPO3, Sitefinity, etc.). Based on the article content, I'll replace the CMS competitors mentioned (WordPress, Joomla, and Mambo which is referenced in the article):
...
- List of content management systems — ▌▌▌▌ vs ▌▌▌▌ vs Drupal (includes competitors such as ▌▌▌▌, ▌▌▌▌, and ▌▌▌▌)