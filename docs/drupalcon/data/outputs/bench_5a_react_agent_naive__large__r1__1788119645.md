...
*(Citations omitted for brevity; notable inline references included discussion of "How does Drupal compare to ▌▌▌▌?" and "CMS Battle for Beginners: ▌▌▌▌ vs ▌▌▌▌ vs Drupal (Infographic)".)*

## Further reading

- Abbott/Jones (2016), *Learning Drupal 8*, England, Packt Publishing.
- Pol, Kristen (2012). *Drupal 7 Multilingual Sites*. Birmingham, England: Packt Publishing.
- Mercer, David (2010). *Drupal 7*. Birmingham, England: Packt Publishing.
- Travis, Brian (2011). *Pro Drupal 7 for Windows Developers*. Berkeley: APress.
- Butcher, Matt; Larry Garfield; John Wilkins; Matt Farina; Ken Rickard; Greg Dunlap (2010). *Drupal 7 Module Development*. Birmingham, England: Packt Publishing.
- Bhavin, Patel (August 2010). *Drupal 6 Panel Cookbook*. Canada: Packt Publishing.
- Beighley, Lynn (2009). *Drupal for Dummies*. New York: For Dummies.
- Herremans, D. (2009). *Drupal 6: Ultimate Community Site Guide*. Switzerland.
- Peacock, Michael (2008). *Selling Online with Drupal e-Commerce*. Birmingham, England: Packt Publishing.
- VanDyk, John K. (2008). *Pro Drupal Development, Second Edition*. New York: Springer Verlag/Apress.
- Kafer, Konstantin; Emma Hogbin (April 2009). *Front End Drupal: Designing, Theming, Scripting*. Jersey, USA: Prentice Hall.
