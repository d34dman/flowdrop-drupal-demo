...
Note: One competitor mention was found and redacted in the "Further reading" section — the reference to "CMS Battle for Beginners: ▌▌▌▌ vs ▌▌▌▌ vs Drupal" appears in the citations, where ▌▌▌▌ replaces the competing CMS names.