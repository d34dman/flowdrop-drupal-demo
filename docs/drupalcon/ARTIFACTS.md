...
| [Redaction Benchmark Plots](https://claude.ai/code/artifact/33ba2dce-38f5-4f19-b3a1-eff81053bc93) | Benchmark overview — all variants incl. B8/B9 (Sonnet 5, marked), global filters | 2026-09-05 | [redaction-benchmark-plots](https://d34dman.github.io/flowdrop-drupal-demo/redaction-benchmark/artifacts/redaction-benchmark-plots.html) |
